...
function List() {
  ...
  return  (
    ...
    {items.map((item, index) => (
      ...
      >
        <div className="flex p-3 border-l-8 border-yellow-600 scrolling-list">
          <div className="space-y-1 border-r-2 pr-3">
            <div className="text-sm leading-5 font-semibold">
              <span className="text-xs leading-4 font-normal text-gray-500"> Poojai #</span> {item.Num}
            </div>
          ...
          <div className="flex-1">
            <div className="ml-3 space-y-1 border-r-2 pr-3">
              ...
              <div className="text-sm leading-4 font-normal">
                <span className="text-xs leading-4 font-normal text-gray-500"> Customer</span> {item.Poojai}
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="ml-3 my-5 bg-yellow-600 p-1 w-20 rounded-full">
